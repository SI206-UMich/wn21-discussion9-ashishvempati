...
def getCharmanderLink(soup):
    ...
    anchor1 = soup.find('div', class_ = 'infocard-list infocard-list-pkmn-lg')
    anchor2 = anchor1.find_all('span', class_ = 'infocard-lg-img')[3]
    anchor3 = anchor2.find('a')['href']
    return domain + anchor3
...
def getEggMoves(pokemon):
    ...
    anchor1 = soup.find_all('table', class_ = 'data-table')[2]
    anchor2 = anchor1.find_all('a', class_ = 'ent-name')
    final = []
    for move in anchor2:
        final.append(move.text)
    return final
